...
import javax.swing.*; 												//built by Arfan (15CE13)
...
public static void introa()
	{
		System.out.println("This program Myshare v1.0 is using package myshareabout.  - Project By Arfan Shaikh (15CE13)");
	}
...
public static void abts()
	{
      ...
      n3.add(new JLabel(new ImageIcon("MyShare v1.0/myshareabout/a.png")));
